...
public class JdbcTrackingConfig implements TrackingConfigPort {
    private static final Map<String, String> DEFAULTS = Map.ofEntries(
            ...
            Map.entry(ETA_EBIKE_SPEED_KMH, "15"),
            Map.entry(ETA_DEFAULT_HANDOFF_SECONDS, "180"),
            Map.entry(ETA_LIVE_RECOMPUTE_INTERVAL_SECONDS, "30"),
            Map.entry(DETOUR_FACTOR, "1.35"),
            Map.entry(CUSTOMER_TRAIL_SECONDS, "180"),
            Map.entry(CUSTOMER_TRAIL_MAX_POINTS, "20"),
