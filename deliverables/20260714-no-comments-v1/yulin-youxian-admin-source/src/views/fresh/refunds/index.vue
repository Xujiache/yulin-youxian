...
import { approveRefund, createAdminRefund, getOrderDetail, getRefunds, rejectRefund, searchCustomers, updateRefundAmount, type AdminCustomer, type OrderDetail, type Refund } from '@/api/admin';
...
const submitAmount = async () => {
    if (!currentRefund.value || amountYuan.value <= 0)
        return;
