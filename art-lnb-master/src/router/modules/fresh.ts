...
export const freshRoutes: AppRouteRecord = {
  ...
  children: [
    ...
    },
    {
      ...
      name: 'FreshCatalog',
      component: '',
      redirect: '/fresh/catalog/categories',
      meta: {
        title: '商品中心',
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            ...
            isHide: true,
            keepAlive: false,
            activePath: '/fresh/catalog/products'
          }
        },
        {
          path: 'banners',
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            title: '波次详情',
            isHide: true,
            activePath: '/fresh/delivery/waves'
          }
        },
        {
          path: 'riders',
        ...
        },
        {
          ...
          meta: {
            title: '骑手详情',
            isHide: true,
            activePath: '/fresh/delivery/riders'
          }
        },
        {
          path: 'exceptions',
    ...
    },
    {
      ...
      name: 'FreshMarketing',
      component: '',
      redirect: '/fresh/marketing/lucky-draw',
      meta: {
        title: '营销中心',
